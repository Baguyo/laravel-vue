  ...
  <Box>
    ...
    >
      <section class="flex items-center gap-2 my-4">
        <input 
          class="border rounded-md file:px-4 file:py-2 border-gray-200 file:text-gray-700 file:border-0 file:bg-gray-100 file:font-medium file:hover:bg-gray-200 file:hover:cursor-pointer file:mr-2"
